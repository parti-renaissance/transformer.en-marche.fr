...
function findManifesto(manifestos, id) {
    const { titles = {}, descriptions = {}, slugs = {} } =
...
export default function measuresReducer(
    ...
    switch (action.type) {
        ...
        case `${VOTES}_FULFILLED`: {
            ...
            votes = votes.filter(
                ({ itemId }) =>
                    typeof itemId === 'number' && state.measures[itemId]
            )
            return {
                ...state,
                measures: {
            ...
            return {
                ...
                measures: {
                    ...
                    ...votes.reduce(
                        (s, { itemId: id }) => ({
                            ...s,
                            [id]: Object.assign({}, state.measures[id], {
                                isActive: true,
                            }),
                        }),
                        {}
        ...
        case `${VOTE_DOWN}_REJECTED`: {
            ...
            return {
                ...state,
                measures: Object.keys(measures).reduce(
                    (s, k) => ({
                        ...s,
                        [k]: Object.assign({}, measures[k], {
                            isPending: false,
                        }),
                    }),
                    {}
