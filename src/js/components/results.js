        ...
        return (
            <div className="intro">
                ...
                <div className="intro-description">
                    ...
                    <T.span
                        text="results.profileBlurb"
                        context={locale}
                        title={profile.titles[locale]}
                    />
                </div>
            </div>
        )
...
const NoResults = locale => (
    <div className="mesure-none">
        {T.translate('results.noResults', { context: locale })}
...
class ResultsList extends Component {
    ...
    render() {
        ...
        if (!hits.length) {
            ...
            return hits.map(hit => (
                <ThemeDetail hit={hit} key={hit.id} isFiltering={isFiltering} />
            ))
        }
    }
}
...
class Results extends Component {
    shouldComponentUpdate({
        ...
        if (
            menu.profileIds !== nextMenu.profileIds ||
            !isEqual(
                refinementList[`titles.${locale}`],
                nextList[`titles.${locale}`]
            ) ||
    ...
    render() {
        ...
        let isFiltering = refinementList[`titles.${locale}`]
            ? !!refinementList[`titles.${locale}`].length
            : false
        return (
            <div className="results">
                <Profile
                    profileId={menu.profileIds}
                    profiles={profiles}
                    locale={locale}
                />
